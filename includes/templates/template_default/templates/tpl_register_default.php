...
<?php
echo zen_draw_form('create_account', zen_href_link(FILENAME_REGISTER, '', 'SSL'), 'post', 'onsubmit="return check_form(register);"') . zen_draw_hidden_field('action', 'process') . zen_draw_hidden_field('email_pref_html', 'email_format'); 
?>
...
echo zen_draw_hidden_field('guest_checkout', 1);
?>
    <div id="opc-ca-outer">
        <div id="opc-ca-left">
<?php
...
<?php
echo zen_draw_radio_field('email_format', 'HTML', ($email_format == 'HTML' ? true : false),'id="email-format-html"') . 
