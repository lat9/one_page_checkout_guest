...
define('ENTRY_EMAIL_MISMATCH_ERROR', 'The <em>Email</em> and <em>Confirm Email</em> entries do not match.');
define('ENTRY_EMAIL_MISMATCH_ERROR_JS', '* The "Email" and "Confirm Email" entries do not match.');